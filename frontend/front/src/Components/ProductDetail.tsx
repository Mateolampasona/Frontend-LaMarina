...
import { ShoppingCart, Heart, Star, ChevronDown, ChevronUp, Share2, ArrowLeft, Truck  } from 'lucide-react';
          ...
          <aside className="order-3">
            <div className="hidden lg:block sticky top-4 space-y-4">
              <div className="bg-white rounded-xl p-6 shadow-lg">
                <h3 className="font-semibold text-lg mb-4">Productos Relacionados</h3>
                <div className="space-y-4">
                  {[1, 2, 3].map((item) => (
                    <div 
                      key={item} 
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg">
                <h3 className="font-semibold text-lg mb-4">Beneficios Exclusivos</h3>
                <div className="space-y-4">
                  <div className="p-4 bg-gradient-to-r from-red-50 to-red-100 rounded-lg">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-800">Compra Mayorista</span>
                    </div>
                  ...
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-800">Pack Limpieza</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  <div className="p-4 bg-gradient-to-r from-green-50 to-green-100 rounded-lg">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-800">Envío Sin Cargo</span>
                    </div>
                    <p className="text-sm text-gray-600">
                  ...
                  <div className="p-4 bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-800">Cliente Frecuente</span>
                    </div>
                    <p className="text-sm text-gray-600">
