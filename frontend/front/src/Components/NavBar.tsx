...
const navItems = [
  {
    ...
    submenu: [
      ...
      { name: "Todos los Productos", href: "./categorias" },
    ],
  },
  {
    name: "Categorías",
    href: "/categorias",
    submenu: [
      { name: "Limpieza", href: "/categorias" },
      { name: "Utencilios", href: "/categorias" },
      { name: "Hogar", href: "/categorias" },
      { name: "Quimicos", href: "/categorias" },
      { name: "Todas Las categorias", href: "/categorias" },
    ],
  },
