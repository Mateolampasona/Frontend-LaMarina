  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <Select name="reason" onValueChange={(value) => setFormData(prevState => ({ ...prevState, reason: value }))}>
            <SelectTrigger>
            ...
            <SelectContent>
              ...
              <SelectItem value="insatisfecho">No satisfecho con el producto</SelectItem>
    ...
    <div className="mt-6 p-4 border border-gray-200 rounded-md">
      ...
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>Los gastos de envío para devoluciones son responsabilidad del cliente, excepto en casos de productos defectuosos.</li>
        <li>El reembolso se procesará en un plazo de 5-10 días hábiles una vez recibido y revisado el producto.</li>
      </ul>
    </div>
  )
}
