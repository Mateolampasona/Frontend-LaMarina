...
const PaymentSuccess = () => {
      ...
      if (id && collection_status && payment_id && status && preference_id) {
        try {
          const response = await fetch(
            `${process.env.NEXT_PUBLIC_BACKEND_URL}/payment/success`,
            {
              method: "POST",
              headers: {
          ...
          // Mostrar modal de éxito y redirigir al home
          Swal.fire({
            title: "Éxito",
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      <h1 className="text-4xl font-bold mb-4 text-purple-500 animate-pulse">
        Espera un momento
      </h1>
