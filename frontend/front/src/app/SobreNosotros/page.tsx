...
import { Sparkles, ShieldCheck, TrendingUp, Users, Truck, PhoneCall } from 'lucide-react'

const features = [
  {
    icon: Sparkles,
    title: 'Calidad Superior',
    description: 'Ofrecemos productos de la más alta calidad para satisfacer todas tus necesidades de limpieza y hogar.'
  },
  {
    icon: ShieldCheck,
    title: 'Confiabilidad',
    description: 'Con años de experiencia, nos hemos ganado la confianza de nuestros clientes por nuestra dedicación y servicio excepcional.'
  },
  {
    icon: TrendingUp,
    title: 'Innovación Constante',
    description: 'Nos mantenemos al día con las últimas tendencias y tecnologías en productos de limpieza y artículos de bazar.'
  },
  {
    icon: Users,
    title: 'Atención Personalizada',
    description: 'Nuestro equipo está comprometido a brindarte una atención personalizada y asesoramiento experto.'
  },
  {
    icon: Truck,
    title: 'Entrega Rápida',
    description: 'Garantizamos entregas rápidas y seguras para que tengas tus productos cuando los necesites.'
  },
  {
    icon: PhoneCall,
    title: 'Soporte 24/7',
    description: 'Estamos disponibles las 24 horas, los 7 días de la semana para atender tus consultas y pedidos.'
  }
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-600 max-w-3xl mx-auto">
            Desde ...., en <span className='text-[#ef233c]'>La Marina</span> nos dedicamos a hacer brillar hogares y negocios con nuestros productos de limpieza y artículos de bazar de primera calidad.
          </p>
        </motion.div>
        ...
        <div className="mt-20 grid font-mono grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            ...
            >
              <div className="absolute inset-0 bg-white rounded-lg shadow-lg transform transition-all duration-300 ease-in-out"
                   style={{
                     transform: hoveredIndex === index ? 'scale(1.05)' : 'scale(1)',
                     boxShadow: hoveredIndex === index ? '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' : 'none'
                   }}
              />
